    ...
    <div className="relative max-w-[340px]">
      <AnimatePresence mode="wait">
        <motion.div
          ...
          className="relative bg-surface-elevated border border-border rounded-2xl px-4 py-4 shadow-warm-md"
        >
          <p className="text-lg text-text-primary leading-snug">{text}</p>
          {tail === 'bottom-left' && (
            <span
              aria-hidden
